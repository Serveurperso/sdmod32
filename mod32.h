...
#define SOUNDBUFFERSIZE 8192                      // Stereo circular sound buffer 2 * 8192 = 16384 bytes of memory
#define FATBUFFERSIZE 4096                        // File system buffers CHANNELS * 4096 = 73728 bytes of memory
